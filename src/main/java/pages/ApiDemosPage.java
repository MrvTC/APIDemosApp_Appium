...
public class ApiDemosPage {
    ...
    By tabs_touchPaint = MobileBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().description(\"Touch Paint\"))");
    ...
    public void clickTouchPaintTab() {
        ...
        elementHelper.click(tabs_touchPaint);
